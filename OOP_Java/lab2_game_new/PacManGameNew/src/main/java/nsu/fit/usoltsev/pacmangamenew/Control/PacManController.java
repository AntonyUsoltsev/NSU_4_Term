...
public class PacManController {
    ...
    public static void newGame() {
        try {
            ...
            //root.getChildren().add(FXMLLoader.load(Objects.requireNonNull(PacManController.class.getResource("pause.fxml"))));
    ...
    public static void pause() {
        try {
            Node pauseMenu = FXMLLoader.load(Objects.requireNonNull(PacManController.class.getResource("inGameMenu.fxml")));
            root.getChildren().add(pauseMenu);
            Button startBtn = (Button) root.lookup("#startButton");
            Button menuBtn = (Button) root.lookup("#menuButton");
            startBtn.setOnAction(event -> root.getChildren().remove(pauseMenu));
            menuBtn.setOnAction(event -> newMenu());
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    }
